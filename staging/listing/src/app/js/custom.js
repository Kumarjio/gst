$(document).ready(function(){
	...
	$("#chk-all-1").click(function () {
		$("#filterPanel2 .pseudo-checkbox").prop('checked', $(this).prop('checked'));
	});
	$("#chk-all-2").click(function () {
		$("#filterPanel3 .pseudo-checkbox").prop('checked', $(this).prop('checked'));
	});
