...
//	$params = '{"signature":"'.$sgin.'","marker":"129036","host":"gosearchtravel.com","user_ip":"127.0.0.1","locale":"ru","trip_class":"Y","passengers":{"adults":1,"children":0,"infants":0},"segments":[{"origin":"MOW","destination":"LED","date":"2017-06-18"},{"origin":"LED","destination":"BER","date":"2017-06-25"}]}';
	...
	//one_way
	$hashString = "0e0a6ef0bea947285477e87e42663e22:flights.gosearchtravel.com:en:129036:1:0:0:2017-06-18:LED:MOW:Y:185.164.137.16";
	$sgin = md5($hashString);

	$params ='{"signature":"'.$sgin.'","marker":"129036","host":"flights.gosearchtravel.com","user_ip":"185.164.137.16","locale":"en","trip_class":"Y","passengers":{"adults":1,"children":0,"infants":0},"segments":[{"origin":"MOW","destination":"LED","date":"2017-06-18"}]}';
