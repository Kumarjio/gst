...
<tbody><tr><td>\
<a href=\"javascript:void(0);\" onclick=\"insert_smiley(':-)', 'status_msge')\">\
<img src=\"../smileys/grin.gif\" alt=\"grin\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smiley(':lol:', 'status_msge')\">
<img src=\"http://localhost/EVITY/assets/global/plugins/chat/smileys/lol.gif\" alt="LOL" style="border:0;" height="19" width="19"></a></td>
<td><a href="javascript:void(0);" onclick="insert_smiley(':)', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/smile.gif" alt="smile" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(';-)', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/wink.gif" alt="wink" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':rofl:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/rofl.gif" alt="rofl" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':wow:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/surprise.gif" alt="surprised" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':blank:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/blank.gif" alt="blank stare" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':angel:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/angel.gif" alt="angel" style="border:0;" height="19" width="19"></a></td></tr>
<tr>
<td><a href="javascript:void(0);" onclick="insert_smiley(':blush:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/blush.gif" alt="blush" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':crying:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/crying.gif" alt="crying" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':dull:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/dull.gif" alt="dull" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':envy:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/envy.gif" alt="envy" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':giggle:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/giggle.gif" alt="giggle" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':happy:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/happy.gif" alt="happy" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':hi:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/hi.gif" alt="hi" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':mmm:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/mmm.gif" alt="mmm" style="border:0;" height="19" width="19"></a></td></tr>
<tr>
<td><a href="javascript:void(0);" onclick="insert_smiley(':party:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/party.gif" alt="party" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':sleepy:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/sleepy.gif" alt="sleepy" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':yawn:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/yawn.gif" alt="yawn" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':worried:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/worried.gif" alt="worried" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley('&gt;:-(', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/angry.gif" alt="angry" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':zip:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/zip.gif" alt="zipper" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':kiss:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/kiss.gif" alt="kiss" style="border:0;" height="19" width="19"></a></td><td><a href="javascript:void(0);" onclick="insert_smiley(':coolhmm:', 'status_msge')"><img src="http://localhost/EVITY/assets/global/plugins/chat/smileys/shade_hmm.gif" alt="cool hmm" style="border:0;" height="19" width="19"></a></td></tr>
</tbody>
</table>";
}
...
<div class=\"dropdown-menu smile-icons\"></div>\
												</div>\
												</div>\
											</div>\
										</div>\
