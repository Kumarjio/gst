...
function smile_data(id){
	html = "<table cellspacing=\"0\" cellpadding=\"4\" border=\"0\">\
<tbody><tr><td>\
<a href=\"javascript:void(0);\" onclick=\"insert_smileis(':-)', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/grin.gif\" alt=\"grin\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" class=\"appendsmile\"  onclick=\"insert_smileis(':lol:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/lol.gif\" alt=\"LOL\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':)', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/smile.gif\" alt=\"smile\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(';-)', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/wink.gif\" alt=\"wink\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':rofl:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/rofl.gif\" alt=\"rofl\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':wow:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/surprise.gif\" alt=\"surprised\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':blank:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/blank.gif\" alt=\"blank stare\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':angel:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/angel.gif\" alt=\"angel\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td></tr>\
<tr>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':blush:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/blush.gif\" alt=\"blush\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':crying:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/crying.gif\" alt=\"crying\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':dull:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/dull.gif\" alt=\"dull\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':envy:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/envy.gif\" alt=\"envy\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':giggle:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/giggle.gif\" alt=\"giggle\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':happy:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/happy.gif\" alt=\"happy\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':hi:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/hi.gif\" alt=\"hi\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':mmm:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/mmm.gif\" alt=\"mmm\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td></tr>\
<tr>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':party:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/party.gif\" alt=\"party\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':sleepy:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/sleepy.gif\" alt=\"sleepy\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':yawn:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/yawn.gif\" alt=\"yawn\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':worried:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/worried.gif\" alt=\"worried\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis('&gt;:-(', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/angry.gif\" alt=\"angry\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':zip:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/zip.gif\" alt=\"zipper\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':kiss:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/kiss.gif\" alt=\"kiss\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td>\
<td><a href=\"javascript:void(0);\" onclick=\"insert_smileis(':coolhmm:', '"+id+"')\">\
<img src=\"assets/global/plugins/user_chat/smileys/shade_hmm.gif\" alt=\"cool hmm\" style=\"border:0;\" height=\"19\" width=\"19\"></a></td></tr>\
</tr></tbody></table>";
return html;
}

function insert_smileis(value,id){
	str = $('#text-'+id).val();
	$('#text-'+id).val(str+' '+value+' ');
}
...
$(document).on('click','a.chat-box-close', function(){
	...
	$('#'+chatboxid).remove();
	c_id = chatboxid.replace('chat-box-', '');
	list.remove(c_id);
										...
										<div class=\"chat-container\">\
											...
											<div class=\"chat-textarea\">\
												<div class=\"input-group\">\
													<input class=\"form-control\" onkeydown=\"checkChatBoxInputKey(event,"+user+",this);\" id=\"text-"+user+"\"  />\
													<div class=\"input-group-btn\">\
<button type=\"button\" class=\"btn btn-default dropdown-toggle smile-btn \" data-toggle=\"dropdown\"><i class=\"fa fa-smile-o\"></i></button>\
														<div class=\"dropdown-menu smile-icons\">"+smile_html+"</div>\
													</div>\
												</div>\
											</div>\
										</div>\
				...
				//for add id in cookie				 
				if($.inArray(user, list.items()) != -1){
				}else{
					list.add(user);                 
				}
				//end cookie
...
var cookieList = function(cookieName) {
	...
	var list = new cookieList("public_chat"); // all items in the array.
$(document).ready(function() {
	$(window).load(function() { 
	if(list.length()>0){
		open_user = list.items();
		 $.each(open_user , function() {
			$("#c-user-"+this).trigger("click");
		});
	}
	});
});	