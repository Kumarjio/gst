<?php
class Website_analytics extends Admin_Controller{
	public $_table_names = 'visitor_activity';
	public $_subView = 'admin/website_analytics/';
	public $_redirect = '/website_analytics';
	...
	function index(){
        $this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],1700).'Website Analytics';
        $this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
		$this->data['all_data'] = $this->comman->get_query('SELECT DISTINCT country FROM visitor_activity',false);
