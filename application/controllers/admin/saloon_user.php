...
class Saloon_user extends Admin_Controller {
	public $_table_names = 'users';
	public $_subView = 'admin/user/';
	public $_redirect = '/saloon_user';
	public function __construct(){
    	parent::__construct();
		$this->data['active'] = 'Saloon Management';
	...
	function index(){
        $this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],1708).'Saloon';
        $this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
		$this->data['table'] = true;

		$this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('account_type'=>"H"),false,false,false);
