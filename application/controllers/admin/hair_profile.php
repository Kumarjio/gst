<?php
class Hair_profile extends Admin_Controller{
	public $_table_names = 'hair_profile';
	public $_subView = 'admin/hair_profile/';
	public $_redirect = '/hair_profile';
	...
	function index(){
        ...
        $this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],17000).'Hair Profile';
    ...
    public function edit($id = NULL){
        ...
        else
        {
			...
			$this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
            $this->data['products'] = $this->step_model->get_new();
	
        }

		$this->data['type'] = array('Man'=>'Man','Woman'=>'Woman');
        $rules = $this->step_model->s_rules1;
        ...
        if($this->form_validation->run() == TRUE){
			...
			$post1 =array('name','description','type');
