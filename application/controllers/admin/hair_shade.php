<?php
class Hair_shade extends Admin_Controller{
	public $_table_names = 'hair_shade';
	public $_subView = 'admin/hair_shade/';
	public $_redirect = '/hair_shade';
	...
	function index(){
        ...
        $this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],17000)."Hair's Shade";
    ...
    public function edit($id = NULL){
        ...
        else
        {
			...
			$this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
            $this->data['products'] = $this->step_model->get_new_shade();
        ...
        $rules = $this->step_model->s_rules3;
        ...
        if($this->form_validation->run() == TRUE){
			...
			$post1 =array('name','description','hair_id');
