...
class Yoga_user extends Admin_Controller {
	public $_table_names = 'users';
	public $_subView = 'admin/user/';
	public $_redirect = '/yoga_user';
	public function __construct(){
    	parent::__construct();
		$this->data['active'] = 'Yoga Management';
	...
	function index(){
        $this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],1708).'Yoga Expert';
