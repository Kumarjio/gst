...
class Ticket extends Admin_Controller{
	...
	function index(){
		...
		$this->data['employee_data'] = $this->comman_model->get_by('admin',array('id !='=>$this->data['admin_details']->id),false,false,false);
		if($this->data['admin_details']->default==1){
			$this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('status'=>'Open','type'=>'GINTESYS'),false,false,false);
			$this->data['all_data2'] = $this->comman_model->get_by($this->_table_names,array('status'=>'In Progress','type'=>'GINTESYS'),false,false,false);
			$this->data['all_data3'] = $this->comman_model->get_by($this->_table_names,array('status'=>'Completed','type'=>'GINTESYS'),false,false,false);
		}
		else{
			$this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('admin_id'=>$this->data['admin_details']->id,'status'=>'Open','type'=>'GINTESYS'),false,false,false);
			$this->data['all_data2'] = $this->comman_model->get_by($this->_table_names,array('admin_id'=>$this->data['admin_details']->id,'status'=>'In Progress','type'=>'GINTESYS'),false,false,false);
			$this->data['all_data3'] = $this->comman_model->get_by($this->_table_names,array('admin_id'=>$this->data['admin_details']->id,'status'=>'Completed','type'=>'GINTESYS'),false,false,false);
		}
    ...
    public function view($id = NULL){
		...
		$this->data['view_data'] = $this->comman_model->get_by($this->_table_names,array('id'=>$id,'type'=>'GINTESYS'), FALSE, FALSE, true);
