...
class Carhire extends Frontend_Controller {


	public $_subView = 'templates/search_car/';
	public function __construct(){
		...
		$this->data['active'] = 'Search Car';
	}

	public function index(){
		$this->data['title'] = "Carhire | ".$this->data['settings']['site_name'];
		$this->data['search'] ='';
