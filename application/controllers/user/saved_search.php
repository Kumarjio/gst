...
class saved_search extends Frontend_Controller{	
	public $_redirect = '/user/saved_search';

	public $_subView = 'user/saved_search/';
...
//		$this->_checkPaidUser();
	...
	function index(){
        ...
        $this->data['name'] = show_static_text($this->data['lang_id'],313);
