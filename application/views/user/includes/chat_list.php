    ...
    <div id="sidebar-wrapper" style="z-index:2">
	    <form class="" action="">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="<?=show_static_text($lang_id,14);?>" name="q" value="" onkeypress="search_item(this.value);" onkeydown="search_item(this.value);" onkeyup="search_item(this.value);" />
            </div>
        </form>
