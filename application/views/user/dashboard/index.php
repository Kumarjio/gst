...
<div class="row">
  <div class="col-lg-4 col-md-6">
    <div class="panel panel-primary">
      ...
      <a href="/user/trip">
      <div class="panel-footer"> <span class="pull-left">Create Trip</span> <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
  ...
  <div class="col-lg-4 col-md-6">
    <div class="panel panel-primary">
      ...
      <a href="/user/saved_search">
      <div class="panel-footer"> <span class="pull-left">Check Saved Search</span> <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
        <div class="clearfix"></div>
      </div>
      </a> </div>
  </div>
