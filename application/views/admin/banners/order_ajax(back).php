		...
		foreach ($array as $item) {
			...
			$str .= '<div class="" alt="'.$item['id'].'" ><img src="'.$image.'" class="img-rounded" style="width:30px;height:30px"> '.$item['name'].'&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<span class="pull-right">
					<div class="btn-group btn-group-xs options"><a class="btn btn-xs btn-primary" href="'.site_url('admin/banner/edit/'.$item['id']).'"><i class="fa fa-edit"></i></a>
					  <a  class="btn btn-xs btn-danger delete" data-loading-text="'.lang('Loading...').'" href="admin/banner/delete/'.$item['id'].'"  onclick="return confirm_box();"><i class="fa fa-remove"></i></a></div></span></div>';
