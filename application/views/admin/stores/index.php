    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th width="180"><?=show_static_text($adminLangSession['lang_id'],5550);?>Name</th>
                    <th width="180"><?=show_static_text($adminLangSession['lang_id'],5505);?>Department</th>
                    <th><?=show_static_text($adminLangSession['lang_id'],5550);?>Username</th>
                    <th><?=show_static_text($adminLangSession['lang_id'],5055);?>Room Count</th>
                    <th><?=show_static_text($adminLangSession['lang_id'],5055);?>Occupation</th>
                    <th><?=show_static_text($adminLangSession['lang_id'],5505);?>Free</th>
                    <th><?=show_static_text($adminLangSession['lang_id'],5550);?>Price</th>
                    <th><?=show_static_text($adminLangSession['lang_id'],555);?>Feature</th>
...
<a class="btn btn-icon-only btn-warning " href="<?=$admin_link?>/store/calander/<?=$set_data->id?>" ><i class="fa fa-calendar"></i></a>
