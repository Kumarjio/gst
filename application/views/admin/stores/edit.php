...
<div class="form-body">                    
	...
	<div class="form-group" >
        <label class="col-lg-2 control-label" style="padding-top:0px">Username<?=show_static_text($adminLangSession['lang_id'],574);?></label>
        <div class="col-lg-10"><?=$user_data->first_name.' '.$user_data->last_name;?></div>
    </div>

	<div class="form-group" >
        <label class="col-lg-2 control-label" style="padding-top:0px">Email<?=show_static_text($adminLangSession['lang_id'],574);?></label>
        <div class="col-lg-10"><?=$user_data->email;?></div>
    </div>
	
    	<div class="form-group" >
            <label class="col-lg-2 control-label"><?=show_static_text($adminLangSession['lang_id'],401);?>Name</label>
            <div class="col-lg-10">
...
<?php
$set_feature = explode(',',$stores->department_id);
...
?>
    ...
    <div class="form-group" >
        ...
        <div class="col-lg-10">
            <?=form_input('total_room', set_value('total_room', $stores->{'total_room'}), 'class="form-control " id="" placeholder=""')?>
        </div>
    </div>
 ...
 <div class="form-group">
  ...
  <div class="col-lg-10">
    ...
    <div class="form-group" >
        ...
        <div class="col-lg-10">
<?php
$city = $this->custom_model->get_city_name();
?>
<select class="form-control" name="city" id="" style="" required >
<option value="">Select </option>
<?php
if($city){
	foreach($city as $setCate){
?>
	<option value="<?=$setCate?>" <?=($stores->city==$setCate)?'selected="selected"':'';?> ><?=$setCate?></option>
<?php
	}	
}
?>
...
<div class="form-group">
  ...
  <div class="col-lg-10">
    <div class="fileinput fileinput-new" data-provides="fileinput">
        ...
        <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
    <?php echo !isset($stores->logo) ? '' :'<a href="'.$_cancel.'/remove_file/logo/'.$stores->id.'" class="btn btn-default" >Remove Image</a>'; ?>
    </div>
    </div>
        <!--<input type="file" name="logo" id="logo" />-->
  </div>
