     ...
     <div class="form-body">                    
        <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
					<?php echo !isset($products->video) ? '' :$products->video.'<a href="'.$_cancel.'/remove_video/video/'.$products->id.'" class="btn" >Remove</a>'; ?>
            ...
            <div class="form-group" >
            	  <label class="col-lg-2 control-label"><?=lang('')?>Youtube Url</label>
        	      <div class="col-lg-10">
    	            <?=form_input('video_link', set_value('video_link', $products->{'video_link'}), 'class="form-control " id="" placeholder=""')?>
	              </div>
		    </div>
            ...
            <!--<div class="form-group">
              ...
              <div class="col-lg-10" style="padding-top:10px">
                <?=form_checkbox('is_active', '1', set_value('is_active', $products->is_active), 'id="inputDefault" class=" "')?>
              </div>
	        </div>-->
