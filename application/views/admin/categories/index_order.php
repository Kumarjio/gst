<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-5" style="padding:0px">
              	<input type="text" name="title" value="" placeholder="<?=show_static_text($adminLangSession['lang_id'],3);?>" class="form-control"  id="search_title" onkeypress="ajax_search()" onkeyup="ajax_search()" onkeydown="ajax_search()" style="height:30px;margin:0px"/>
        </div>
