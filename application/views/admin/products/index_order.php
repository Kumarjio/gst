...
<div class="row">
    ...
    <p class="alert alert-info">Drag to object and then click 'Save'</p>
...
<script>
$(function(){
    $.post('<?=site_url('admin/product/order_ajax')?>', {}, function(data){
        $('#orderResult').html(data); 
    });    
	...
	$('#save').click(function(){
		...
		$('#orderResult').slideUp(function(){
			$.post('<?php echo site_url('admin/product/order_ajax'); ?>', { sortable: oSortable }, function(data){
				$('#orderResult').html(data);
