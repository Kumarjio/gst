...
<div class="form-body">                    
	...
	<div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,16000);?>Username</label>
        <div class="col-lg-10">
            <?=form_input('username', set_value('username', $user_details->{'username'}), 'class="form-control " id="" placeholder=""')?>
        </div>
    </div>
    <div class="form-group" >
...
?>
    ...
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,2000);?>Post Code</label>
        <div class="col-lg-10">
	        <input type="text" name="zip" class="form-control " value="<?=set_value('zip',$user_details->zip);?>" id="">
    ...
    <div class="form-group" >
        ...
        <div class="col-lg-10">
                    <select class="form-control" title="" name="city" required>
<option value="">Select</option>
<?php
if($cities_data){
	foreach($cities_data as $setCate){
?>
	<option value="<?=$setCate->id; ?>" <?= set_select('city',$user_details->{'city'},TRUE); ?> ><?=$setCate->name; ?></option>
<?php
	}
}
?>
...
?>
	<option value="<?=$setCate; ?>" <?= set_select('country',$user_details->{'country'},TRUE); ?> ><?=$setCate; ?></option>
<?php
	}
}
?>
...
<hr>
<h3>Paypal API Account</h3>
<div>
<div class="form-group" >
	<label class="col-lg-2 control-label">Username</label>
	<div class="col-lg-10">
<?=form_input('api_username', set_value('api_username', $user_details->api_username), 'class="form-control " id="" placeholder="" required')?>
	</div>
</div>                           
<div class="form-group" >
	<label class="col-lg-2 control-label">Signature</label>
	<div class="col-lg-10">
<?=form_input('api_signature', set_value('api_signature', $user_details->api_signature), 'class="form-control " id="" placeholder="" required')?>
	</div>
</div>                           
<div class="form-group" >
	<label class="col-lg-2 control-label">Password</label>
	<div class="col-lg-10">
<?=form_input('api_password', set_value('api_password', $user_details->api_password), 'class="form-control " id="" placeholder="" required')?>
	</div>
</div>                           
</div>
