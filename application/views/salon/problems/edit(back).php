        ...
        <div data-sortable-id="form-stuff-1" class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" type="text" id="best_sellers_start" placeholder="Date" name="date" data-date-format="dd-mm-yyyy" value="<?= set_value('date', $tickets->{'date'})?>" readonly="readonly" />
                  </div>
	          </div>
              <div class="form-group" >
...
<?=form_dropdown('time', $time_data, $this->input->post('time') ? $this->input->post('time') : $tickets->time, 'class="form-control"')?>
                ...
                <div class="form-group">
              <label class="col-lg-2 control-label"><?=show_static_text($lang_id,8000);?>Reason for Ticket</label>
...
?>
                ...
                <div class="form-group" >
                  <label class="col-lg-2 control-label"><?=show_static_text($lang_id,2071);?>Your Time</label>
                  <div class="col-lg-10">
                    <?=form_input('solve_user_time', set_value('solve_user_time', $tickets->{'solve_user_time'}), 'class="form-control " id="" placeholder=""')?>
                  </div>
                </div>
...
<div class="form-group">
  ...
  <div class="col-lg-10">
    <?=form_textarea('desc', html_entity_decode(set_value('desc', $tickets->{'desc'})), 'placeholder="" rows="3" class="cleditor2 form-control"')?>
  </div>
</div>
...
function get_process(id){	
	$.ajax({
		type:"POST",
		url:"<?=$lang_code?>/user_problem/ajax_get_hour",
...
$(document).ready(function(){
	$(".fileuploader").uploadFile({
		url:"<?=$lang_code?>/user_problem/ajax_upload",
		fileName:"myfile",
