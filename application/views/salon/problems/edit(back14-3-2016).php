    ...
    <?=form_textarea('desc', html_entity_decode(set_value('desc', $tickets->{'desc'})), 'placeholder="" id="information" rows="3" class="cleditor2 form-control"')?>
			...
			<div class="form-group" >
                  ...
                  <div class="col-lg-2">
                	...
                	<div class="col-lg-3"><span>I require a response with</span>
                    <?=form_input('solve_user_time', set_value('solve_user_time', $tickets->{'solve_user_time'}), 'class="form-control" style="display:inline;width:81px;" id="" placeholder=""')?>
                  </div>
