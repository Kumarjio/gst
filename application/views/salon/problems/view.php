...
?>
    <div class="row static-info">
        <div class="col-md-3 name"><b>Company Name</b></div>
        <div class="col-md-9 value"><?=$view_data->company_name;?></div>
    </div>
    <div class="row static-info">
        <div class="col-md-3 name"><b><?=show_static_text($lang_id,2036);?>Ticket</b></div>
        <div class="col-md-9 value"><?=$ticketName;?></div>
    </div>
    <div class="row static-info">
...
<!--    <div class="row static-info">
    ...
    <div class="row static-info">
        <div class="col-md-3 name"><b>Response Time</b></div>
        <div class="col-md-9 value"><?=$view_data->solve_time;?> Hrs</div>
    </div>
    <div class="row static-info">
        <div class="col-md-3 name"><b>User Time</b></div>
        <div class="col-md-9 value"><?=$view_data->solve_user_time;?> Hrs</div>
    </div>
<?php
...
<dl class="dl-horizontal">
    <dt>Date</dt>
    <dd><?=$view_data->date.' '.$view_data->time;?></dd>
    <dt>Status</dt>
...
if($view_data->status =='Completed'){
	$checkrating = $this->comman_model->get_by('problems_rating',array('problem_id'=>$view_data->id),false,false,true);
	if(!$checkrating){
?>
<form method="post" action="" id="customer_login" accept-charset="UTF-8" style="padding-top:10px;"  class ="form-horizontal">
	    <input type="hidden" name="<?=$this->security->get_csrf_token_name(); ?>" value="<?=$this->security->get_csrf_hash();?>" />
		<input type="hidden" name="rating_input" value="set"  /> 
<div class="form-group">
	<label class="col-md-3 control-label" style="margin-top:6px">Rating</label>
    <div class="col-md-9">
        <input id="rating-input" name="rate" type="number" value="<?=(isset($user_review)&&!empty($user_review))?$user_review->quality_rate:'3'?>" class="rating rating-input" min=0 max=6 step=1 data-size="xs" data-show-clear="false" data-show-caption="false" data-stars="6" />			  
    </div>    
</div>
<div class="form-group">
	<label class="col-md-3 control-label" style="margin-top:6px">Comment</label>
    <div class="col-md-9">
...
<div class="form-group">
	<label class="col-md-3 control-label" style="margin-top:6px">&nbsp;</label>    
    <div class="col-md-2">
...
<div class="item-rating store" >
    <div class="star_content clearfix">
        <div class="star <?=$checkrating->rate>=1?'star_on':''?>"></div>
        <div class="star <?=$checkrating->rate>=2?'star_on':''?>"></div>
        <div class="star <?=$checkrating->rate>=3?'star_on':''?>"></div>
        <div class="star <?=$checkrating->rate>=4?'star_on':''?>"></div>
        <div class="star <?=$checkrating->rate>=5?'star_on':''?>" ></div>
        <div class="star <?=$checkrating->rate>=6?'star_on':''?>" style="margin-right:5px;"></div>
    </div> 
</div>	
    </dd>

    <dt>Comment</dt>
    <dd><?=$checkrating->comment?></dd>
</dl>
...
if(count($problems_status)){
	foreach($problems_status as $set_data){
		$rProductsFile = $this->comman_model->get_by('problems_files',array('reply_id'=>$set_data->id,'problem_type'=>'reply'),false,false,false);
		$commentName = 'Admin';
