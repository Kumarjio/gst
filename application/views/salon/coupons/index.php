...
?>
                        <tr>
							...
							<td>
                            <a class="btn btn-icon-only btn-info " href="<?=$_cancel.'/user_form/'.$set_data->type.'/'.$set_data->id;?>" >
										<i class="fa fa-mail-forward"></i></a>
                            <a class="btn btn-icon-only btn-success" href="<?=$_edit.'/'.$set_data->id;?>" >
										<i class="fa fa-edit"></i></a>
                            	<a class="btn btn-icon-only btn-danger " href="<?=$_delete.'/'.$set_data->type.'/'.$set_data->id;?>"  onclick="return confirm_box();" >
