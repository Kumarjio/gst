                 ...
                 <?=form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form','enctype'=>"multipart/form-data"))?>
                 	...
                 	<div class="col-md-12">
                        <div class="form-group">
                          <label class="col-lg-2 control-label"><?=show_static_text($lang_id,17008);?>Coming</label>
                          <div class="col-lg-10">

							<select class="s2_with_tag form-control" name="b_day" onChange="get_process(this.value);" required>
                        ...
                        <div class="form-group">
                          <label class="col-lg-2 control-label"><?=show_static_text($lang_id,178);?></label>
                          <div class="col-lg-10">

							<select class="s2_with_tag form-control" name="user_id"  id="user-data" required>
								<option value="">Select</option>
							</select>
                          </div>
                        </div>
