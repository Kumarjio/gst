...
<div class="form-body">                    
	<div class="col-md-12">						                        
    	...
    	<div class="form-group" >
            <label class="col-lg-2 control-label"><?=show_static_text($lang_id,401);?>Store Name</label>
            <div class="col-lg-10">
...
<div class="form-group">
  <label class="col-lg-2 control-label">Restaurant Type</label>
  <div class="col-lg-10">

    <select  multiple="multiple" class="s2_with_tag" name="category[]" id="select_size" style="width:95%">
<?php
$set_feature = explode(',',$stores->category);

if(isset($categories_data)&&!empty($categories_data)){
	foreach($categories_data as $set_category){
		if(!empty($set_feature)&&in_array($set_category->id,$set_feature)){

?>
	<option value="<?=$set_category->id; ?>" selected="selected" ><?=$set_category->title; ?></option>
<?php
		}
		else{
?>
...
?>
    ...
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,401);?>Address</label>
        <div class="col-lg-10">
    ...
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,401);?>Post Code</label>
        <div class="col-lg-10">
            <?=form_input('zip', set_value('zip', $stores->{'zip'}), 'class="form-control " id="zip-input" placeholder="" ')?>
        </div>
    </div>
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,401);?>City</label>
        <div class="col-lg-10">
    ...
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,401);?>Country</label>
        <div class="col-lg-10">
	...
	<div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,991);?>Distance</label>
        <div class="col-lg-10">
    ...
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,401);?>Phone Number</label>
        <div class="col-lg-10">
...
<div class="form-group">
  ...
  <div class="col-lg-10">
    <div class="fileinput fileinput-new" data-provides="fileinput">
        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
            <?php echo (isset($stores->logo)&&!empty($stores->logo)) ? '<img src="'.base_url('assets/uploads/stores/thumbnails').'/'.$stores->logo.'" >':'<img src="assets/uploads/no-image.gif">'; ?>
        </div>
        <div>
        <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
...
<img style="height:100px;width:100%" alt="" class="img-responsive" src="assets/uploads/stores/<?=$set_products_file->filename?>"></a>
</div>
