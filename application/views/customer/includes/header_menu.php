				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs"><?=$user_details->first_name?>
</span> <b class="caret"></b>
						</a>
						<ul class="dropdown-menu animated fadeInLeft">
							<li class="arrow"></li>
							<li><a href="<?=$lang_code?>/company/change_password"><?=show_static_text($lang_id,50);?></a></li>
							<li class="divider"></li>
							<li><a href="<?=$lang_code?>/company/logout"><?=show_static_text($lang_id,57);?></a></li>
						</ul>
					</li>
