...
<?php
if(!empty($user_chat_data->image)){
	$set_image = 'assets/uploads/users/thumbnails/'.$user_chat_data->image;
}
else{
...
?>                    
                    ...
                    <strong style="font-size:15px;"><?php echo $user_chat_data->first_name;?></strong>
                    <div class="clearfix"></div>
	                    
            </header> 
            <section class="panel-body chat-list" style="min-height:382px"> 
...
?>                    
            ...
            <form action="#" class="m-b-none" id="submitForm" method="post" onSubmit="return false">
					...
					<input name="user_name" type="hidden" id="user_name" value="<?php echo $user_chat_data->first_name;?>"/>
					<input name="user_id" type="hidden" id="user_id" value="<?php echo $user_chat_data->id;?>"/>
					<input name="file_name" type="hidden" id="file_name" value=""/>
                <div class="input-group">
                <textarea id="textb" name="textb" placeholder="<?=show_static_text($lang_id,156)?>" class="form-control" style="height:50px"></textarea>
				...
				<br>
                <button class="btn btn-primary" type="submit" style=""><?=show_static_text($lang_id,155)?></button> </span> </div> </form>
