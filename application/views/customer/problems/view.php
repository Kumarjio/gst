...
?>
    <div class="row static-info">
        ...
        <div class="col-md-9 value"><?=$view_data->user_name;?></div>
    </div>
    <div class="row static-info">
    ...
    <div class="row static-info">
        <div class="col-md-3 name"><b><?=show_static_text($lang_id,2306);?>Ticket</b></div>
    ...
    <div class="row static-info">
        ...
        <div class="col-md-9 value"><?=$view_data->solve_time;?> Hrrs</div>
    </div>
    <div class="row static-info">
...
<div class="form-group" >
    ...
    <div class="col-lg-3">
            <?=form_submit('submit', show_static_text($lang_id,235), 'class="btn btn-primary"')?></div>
    </form>
</div>
<?php
}
...
<!--			                <span class="userimage"><img src="assets/img/user-1.jpg" alt="" /></span>-->
			                <span class="username"><a href="javascript:;"><?=$set_data->user_id==$user_details->id?$user_details->first_name." ".$user_details->last_name:'Admin'?></a> <small></small></span>
...
$( document ).ready(function() {
	...
	$( "#reply-form" ).submit(function() {
		var order_id ='<?=$view_data->id?>';
		var username ='<?=$user_details->first_name." ".$user_details->last_name?>';
