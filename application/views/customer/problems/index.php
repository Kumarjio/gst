...
<ul class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">All Ticket</a></li>
    <li class=""><a href="<?=$_cancel.'/urgent';?>">Urgent</a></li>
</ul>
    <div class="table-responsive" style="padding-top:10px">
        <table id="data-table" class="table table-striped table-bordered">
                ...
                <tr>
	                ...
	                <th><?=show_static_text($lang_id,1600);?>Company Name</th>
	                ...
	                <th width="150"><?=show_static_text($lang_id,258);?></th>
                </tr>
                </thead>
                <tbody>
