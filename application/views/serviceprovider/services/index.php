    ...
    <div class="table-responsive">
        ...
        <thead>
              <tr>
                ...
                <th><?=show_static_text($lang_id,1607);?>Type</th>
...
if(count($all_data)){
	foreach($all_data as $set_data){
		if(isset($set_data->image)){
			$image = base_url('assets/uploads/services/small').'/'.$set_data->image; 
		}
		else{
...
?>
                        <tr>
							...
							<td> <?=print_lang_value('services',$lang_id,array('id'=>$set_data->s_id),'service_id','title')?></td>
