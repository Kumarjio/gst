...
?>
    ...
    <div class="row static-info">
        <div class="col-md-3 name"><b><?=show_static_text($lang_id,34);?></b></div>
...
?> 
    <div class="row static-info">
        <div class="col-md-3 name"><b><?=show_static_text($lang_id,70);?></b></div>
...
?>
    <div class="row static-info">
        <div class="col-md-3 name"><b><?=show_static_text($lang_id,305);?> <?=$j?></b></div>
...
<div class="panel panel-default">
    <div class="panel-heading">                            
        <h4 class="panel-title"><?=show_static_text($lang_id,373);?></h4>
    </div>
    <div class="panel-body">
<dl class="dl-horizontal">
    <dt><?=show_static_text($lang_id,153);?></dt>
    <dd><?=$view_data->on_date;?></dd>
    <dt><?=show_static_text($lang_id,158);?></dt>
...
?>				
                <li>
			        ...
			        <div class="timeline-body">
	                    <div class="timeline-header">
			                <span class="username"><a href="javascript:;"><?=show_static_text($lang_id,327);?></a> <small></small></span>
