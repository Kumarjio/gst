<?php $this->load->view('serviceprovider/includes/header'); ?>
<script>
...
<?php $this->load->view('serviceprovider/includes/header_menu'); ?>
		
<?php $this->load->view('serviceprovider/includes/left_menu'); ?>
<?php $this->load->view('serviceprovider/includes/chat_list'); ?>
		<div class="sidebar-bg"></div>
		<!-- end #sidebar -->
		
		<!-- begin #content -->
		<div id="content" class="content">
<?php $this->load->view('serviceprovider/includes/address'); ?>
