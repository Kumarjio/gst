...
<!--<div class="page-header">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12">
              <h2 class="entry-title"><?=show_static_text($lang_id,2);?></h2>
              <div class="breadcrumb">
                
                <a href=""><?=show_static_text($lang_id,10);?></a>
                <span class="crumbs-spacer"><i class="fa fa-angle-double-right"></i></span>
                <span class="current"><?=show_static_text($lang_id,2);?></span>
              </div>
            </div>
          </div>
        </div>
    ...
    ?>
        ...
        <?php //echo validation_errors();?>   
                ...
                <input type="hidden" name="operation" value="set"  /> 
                      ...
                      <button type="submit" class="btn btn-sys btn-block">Login</button>
