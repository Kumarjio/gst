...
<div class="sidebox-container bg-sys search-form-wp servi_tab">
<?php  $get=$_SERVER['REQUEST_URI']; $test=explode('/',$get); //print_r($test); 
...
{ //echo "Hello umrah";
		...
		else if($service == "travel-insurance")
		{ //echo "Hello travel-insurance";
	}
