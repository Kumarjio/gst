...
<div class="search-wrapper">
    <div class="search-form-wp" >
	    <div class="search-container bg-sys" style="margin-bottom:0">
        ...
        <div class="form-group">
            <div class="col-md-2 col-sm-12 col-xs-12 margin-bottom-10">
    	        ...
    	        <div class="input-group">
                    ...
                    <input type="text" name="city" value="<?=$this->input->get('city')?>" class="form-control"  aria-required="true" required>
                </div>
            </div>
    ...
    <div class="search-container bg-purple3">
<?php
...
?>    
    ...
    <div class="row">
        ...
        <div class="items"><?=$lang_currency?> <span class="s-min-price"><?=$min_price?$min_price:0?></div>
