   ...
   public $rules_lang = array();
    ...
    public function __construct(){
        ...
        foreach($this->languages as $key=>$value)
        {
            ...
            $this->rules_lang["body1_$key"] = array('field'=>"body1_$key", 'label'=>'Body', 'rules'=>'');
            $this->rules_lang["body2_$key"] = array('field'=>"body2_$key", 'label'=>'Body', 'rules'=>'');
            $this->rules_lang["body3_$key"] = array('field'=>"body3_$key", 'label'=>'Body', 'rules'=>'');
        }
    }
