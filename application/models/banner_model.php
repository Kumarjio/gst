...
class banner_model extends MY_Model {
    ...
    public $rules = array(
        ...
        'desc' => array('field'=>'desc', 'label'=>'Code', 'rules'=>'trim'),
   ...
   public $rules_lang = array();
    ...
    public function __construct(){
        ...
        {
            $this->rules_lang["body_$key"] = array('field'=>"body_$key", 'label'=>'Body', 'rules'=>'');
...
/*
    ...
    public function delete($id){
        $this->db->delete('banners_lang', array('banner_id' => $id)); 
