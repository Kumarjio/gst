...
class Store_category_model extends MY_Model {
    ...
    protected $_table_name = 'stores_category';
...
/*        $templatesDirectory = opendir(APPPATH.'../templates/'.$CI->app_settings['template']);
    ...
    public function delete($id)
    {
		...
		$this->db->set(array('category_id' => 0))->where('category_id', $id)->update('products');
		$this->db->set(array('sub_category_id' => 0))->where('sub_category_id', $id)->update('products');
    }
