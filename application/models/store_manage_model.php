<?php
class Store_manage_model extends MY_Model {    
    protected $_table_name = 'stores_manage';
    protected $_order_by = 'parent_id, order, id';
    public $rules = array(
        'room' => array('field'=>'room', 'label'=>'room', 'rules'=>'trim|required'),
        'price' => array('field'=>'price', 'label'=>'price', 'rules'=>'trim|required'),
        'descripton' => array('field'=>'descripton', 'label'=>'descripton', 'rules'=>'trim|'),
   );
