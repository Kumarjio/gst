...
class Language_model extends MY_Model {    
    ...
    public $rules_admin = array(
        ...
        'currency' => array('field'=>'currency', 'label'=>'Currency', 'rules'=>'trim'),
        'unit' => array('field'=>'unit', 'label'=>'Unit', 'rules'=>'trim'),
...
*/
    ...
    public function get_default($id=false)
    {
        $query = $this->db->get_where($this->_table_name, array('default' => 1), 1);
		if($id){
	        return $query->row()->$id;
    ...
    public function get_unit1($code)
    {
    ...
    public function get_currency1($code)
    {
        $query = $this->db->get_where($this->_table_name, array('id' => $code), 1);
        return $query->row()->currency;
    }
