...
class public_chats{
	...
	*/
	...
	EOD;*/
		...
		$this->ci->db->set('sent', $time);
		$this->ci->db->insert('public_chat', $data); 
		echo "1";
		exit(0);
	}
	...
	function chatHistory(){
		...
		$query = $this->ci->db->get('public_chat');
		$items = '';
		$chatBoxes = array();
	...
	?>
{
	...
	EOD;*/
		...
		$sql = "update public_chat set recd = 1 where public_chat.to = '".mysql_real_escape_string($_SESSION['username'])."' and recd = 0";
