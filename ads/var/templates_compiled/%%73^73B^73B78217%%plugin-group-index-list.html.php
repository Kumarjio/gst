<?php /* Smarty version 2.6.18, created on 2017-04-27 11:07:15
         compiled from plugin-group-index-list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'plugin-group-index-list.html', 30, false),array('modifier', 'escape', 'plugin-group-index-list.html', 43, false),array('function', 'cycle', 'plugin-group-index-list.html', 37, false),)), $this); ?>
...
">
                <td>
                    <?php if ($this->_tpl_vars['aPlugin']['displayname'] != ''): ?>
                        <?php echo ((is_array($_tmp=$this->_tpl_vars['aPlugin']['displayname'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
                ...
                <td><?php if ("{".($this->_tpl_vars['aPlugin']).".authoremail|escape"): ?><a href="mailto:<?php echo $this->_tpl_vars['aPlugin']['authoremail']; ?>
"><?php endif; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['aPlugin']['author'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
